...
ActiveRecord::Schema[7.0].define(version: 2023_01_29_150254) do
  ...
  create_table "reservas", force: :cascade do |t|
    ...
    t.index ["tipo_id"], name: "index_reservas_on_tipo_id"
  end
  ...
  add_foreign_key "reservas", "hoteis"
  add_foreign_key "reservas", "quartos"
  add_foreign_key "reservas", "tipos"
end
