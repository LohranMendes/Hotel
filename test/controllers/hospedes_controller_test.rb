...
class HospedesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospede" do
    assert_difference("Hospede.count") do
      post hospedes_url, params: { hospede: { CPF: @hospede.CPF, idade: @hospede.idade, nome: @hospede.nome } }
    end
  ...
  test "should update hospede" do
    patch hospede_url(@hospede), params: { hospede: { CPF: @hospede.CPF, idade: @hospede.idade, nome: @hospede.nome } }
